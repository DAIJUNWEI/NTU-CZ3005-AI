...
/* for example,when the kids says yes about "eat", it will randomly find follow question in the eat list. */ 
...
/* X is the same list as Y ,so parents will ask the related question. */ 
relatedFollowUp(Y, X) :- 
